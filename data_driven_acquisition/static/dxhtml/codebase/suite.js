...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(33), __webpack_require__(86).setImmediate))
...
var editors_1 = __webpack_require__(186);
...
var ts_grid_1 = __webpack_require__(181);
...
var ts_tree_1 = __webpack_require__(203);
exports.Tree = ts_tree_1.Tree;
var ts_window_1 = __webpack_require__(206);
...
/* WEBPACK VAR INJECTION */}.call(this, __webpack_require__(33), __webpack_require__(88)))
...
var events_1 = __webpack_require__(2);
var html_1 = __webpack_require__(3);
var scrollView_1 = __webpack_require__(99);
var view_1 = __webpack_require__(4);
var ts_data_1 = __webpack_require__(6);
var ts_layout_1 = __webpack_require__(13);
var ts_message_1 = __webpack_require__(19);
    ...
    Form.prototype._addLayoutItem = function (item) {
        ...
        switch (config.type) {
            ...
            case types_1.FormItemType.datepicker:
                ...
                dateInput_2.events.on(types_1.BaseElementEvent.change, function () {
                    var value = dateInput_2.getValue();
                    _this.events.fire(types_1.FormEvents.change, [name, value]);
                    _this._state[name] = value;
                });
                dateInput_2.events.on(types_1.BaseElementEvent.configUpdate, function (newConfig) {
                    var value = dateInput_2.getValue();
                    _this._state[name] = value;
                    _this.layout.cell(dateInput_2.config.id).config = _this._checkLayoutConfig(newConfig, {});
                });
                break;
            case types_1.FormItemType.checkbox:
                ...
                checkbox_2.events.on(types_1.BaseElementEvent.configUpdate, function (newConfig) {
                    var value = checkbox_2.getValue();
                    _this._state[name] = value;
                    _this.layout.cell(checkbox_2.config.id).config = _this._checkLayoutConfig(newConfig, {});
                });
                break;
            case types_1.FormItemType.combo:
                ...
                combo_2.events.on(types_1.BaseElementEvent.configUpdate, function (newConfig) {
                    var value = combo_2.getValue();
                    _this._state[name] = value;
                    _this.layout.cell(combo_2.config.id).config = _this._checkLayoutConfig(newConfig, {});
                });
                if (config.data) {
            ...
            case types_1.FormItemType.input:
                ...
                input_2.events.on(types_1.BaseElementEvent.configUpdate, function (newConfig) {
                    var value = input_2.getValue();
                    _this._state[name] = value;
                    _this.layout.cell(input_2.config.id).config = _this._checkLayoutConfig(newConfig, {});
                });
                break;
            case types_1.FormItemType.radioGroup:
                ...
                radioGroup_2.events.on(types_1.BaseElementEvent.configUpdate, function (newConfig) {
                    var value = radioGroup_2.getValue();
                    _this._state[name] = value;
                    _this.layout.cell(radioGroup_2.config.id).config = _this._checkLayoutConfig(newConfig, {});
                });
                break;
            case types_1.FormItemType.select:
                ...
                select_2.events.on(types_1.BaseElementEvent.configUpdate, function (newConfig) {
                    var value = select_2.getValue();
                    _this._state[name] = value;
                    _this.layout.cell(select_2.config.id).config = _this._checkLayoutConfig(newConfig, {});
                });
                break;
            case types_1.FormItemType.simpleVault:
                ...
                simpleVault_1.events.on(types_1.BaseElementEvent.configUpdate, function (newConfig) {
                    var value = simpleVault_1.getValue();
                    _this._state[name] = value;
                    _this.layout.cell(simpleVault_1.config.id).config = _this._checkLayoutConfig(newConfig, {});
                });
                break;
            case types_1.FormItemType.slider:
                ...
                slider_1.events.on(types_1.BaseElementEvent.configUpdate, function (newConfig) {
                    var value = slider_1.getValue();
                    _this._state[name] = value;
                    _this.layout.cell(slider_1.config.id).config = _this._checkLayoutConfig(newConfig, {});
                });
                break;
            case types_1.FormItemType.textarea:
                ...
                textarea_2.events.on(types_1.BaseElementEvent.configUpdate, function (newConfig) {
                    ...
                    _this._state[name] = value;
                    _this.layout.cell(textarea_2.config.id).config = _this._checkLayoutConfig(newConfig, {});
                });
                break;
            case types_1.FormItemType.text:
                ...
                text_1.events.on(types_1.BaseElementEvent.configUpdate, function (newConfig) {
                    _this.layout.cell(text_1.config.id).config = _this._checkLayoutConfig(newConfig, {});
                });
                break;
            case types_1.FormItemType.timepicker:
                ...
                timeInput_2.events.on(types_1.BaseElementEvent.change, function () {
                    var value = timeInput_2.getValue();
                    _this.events.fire(types_1.FormEvents.change, [name, value]);
                    _this._state[name] = value;
                });
                timeInput_2.events.on(types_1.BaseElementEvent.configUpdate, function (newConfig) {
                    var value = timeInput_2.getValue();
                    _this._state[name] = value;
                    _this.layout.cell(timeInput_2.config.id).config = _this._checkLayoutConfig(newConfig, {});
                });
                break;
            case types_1.FormItemType.colorpicker:
                ...
                colorpickerInput_1.events.on(types_1.BaseElementEvent.change, function () {
                ...
                colorpickerInput_1.events.on(types_1.BaseElementEvent.configUpdate, function (newConfig) {
                    var value = colorpickerInput_1.getValue();
                    _this._state[name] = value;
                    _this.layout.cell(colorpickerInput_1.config.id).config = _this._checkLayoutConfig(newConfig, {});
                });
                break;
        }
        return cell;
...
var ColorpickerInput = /** @class */ (function (_super) {
    ...
    ColorpickerInput.prototype.setConfig = function (config) {
        ...
        this.colorpicker.events.on(ts_colorpicker_1.ColorpickerEvents.colorChange, function () {
...
var view_1 = __webpack_require__(4);
var ts_data_1 = __webpack_require__(6);
var Exporter_1 = __webpack_require__(183);
var data_1 = __webpack_require__(52);
var main_1 = __webpack_require__(20);
var Selection_1 = __webpack_require__(184);
var types_1 = __webpack_require__(10);
var render_1 = __webpack_require__(185);
var core_1 = __webpack_require__(1);
var content_1 = __webpack_require__(77);
var columnsResizer_1 = __webpack_require__(193);
...
var FixedCols_1 = __webpack_require__(192);
...
Object.defineProperty(exports, "__esModule", { value: true });
var types_1 = __webpack_require__(10);
var InputEditor_1 = __webpack_require__(187);
var SelectEditor_1 = __webpack_require__(188);
var DateEditor_1 = __webpack_require__(189);
var CheckboxEditor_1 = __webpack_require__(190);
var ComboboxEditor_1 = __webpack_require__(191);
var lastEditor = {
    cell: {
        row: null,
        col: null
...
var KeyNavigation_1 = __webpack_require__(205);
...
var WindowController_1 = __webpack_require__(209);
